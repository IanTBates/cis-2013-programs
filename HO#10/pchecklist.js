...
var passwordCheckOld = function () 
{
	...
	//by defualt, output is 'password is good' and will check for requirements after
    stringOutput = "Password is good";
  
  //if password is less than 8, it is too short. checks if password is at least 8 characters
  if (stringPassword.length < 8) {
	stringOutput = "Password is too short";
	
  }
  else
  //checks if the password is included in the list of bad passwords
